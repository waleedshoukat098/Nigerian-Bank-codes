...
*/
    ...
    public static void setSystemBarColor(Activity act) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(act.getResources().getColor(com.ads.control.R.color.colorPrimaryDark));
        }
    }
    ...
    public static void clearSystemBarLight(Activity act) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            Window window = act.getWindow();
            window.setStatusBarColor(ContextCompat.getColor(act, com.ads.control.R.color.colorPrimaryDark));
        }
    }
  ...
  /*  public static void displayImageOriginal(Context ctx, ImageView img, @DrawableRes int drawable) {
   ...
   /* public static GoogleMap configActivityMaps(GoogleMap googleMap) {
    ...
    public static void shareApp(Activity activity) {
        ...
        String shareSubText = activity.getString(R.string.app_name);
        String shareBodyText = "https://play.google.com/store/apps/details?id=" + activity.getPackageName();
...
/*
    public static void moreApps(Context context) {
        ...
        intent2.setData(Uri.parse
                ("https://play.google.com/store/apps/developer?id=" + context.getString(R.string.developer_play_store_id)));
    ...
    public static void exitDialog(final Context context) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
              ...
              /*  MainActivityRohi activity  = (MainActivityRohi)context;
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                dialog.cancel();
// MainActivityRohi.super.onBackPressed();
            }
        });
